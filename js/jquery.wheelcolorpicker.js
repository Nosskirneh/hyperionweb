...
(function($) {
	...
	private.updateActiveControl = function( e ) {
		...
		if( settings.preview ) {
			...
			document.getElementById("r").value = red;
			document.getElementById("g").value = green;
			document.getElementById("b").value = blue;
			// change input type submit colors
			// background
			document.getElementById("colorSubmit").style.backgroundColor = `rgba(${red},${green},${blue},0.6)`;
			// borderBottomColor && textShadow
			var r = Math.round(red-11);
			var g = Math.round(green-24);
			var b = Math.round(blue-34);
			document.getElementById("colorSubmit").style.borderBottomColor = `rgba(${r},${g},${b},0.6)`;
			document.getElementById("colorSubmit").style.textShadow = `0px -1px rgba(${r},${g},${b},0.6)`;
